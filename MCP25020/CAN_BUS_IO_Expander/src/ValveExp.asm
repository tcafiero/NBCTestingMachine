...
;;
;; For input messages:
;;   Priority = 0, Class = 0x00, Broadcast = 0, Dest = 0x0C, 
;;         Source = 0x00, Cmd = 0x00
;; 29 bit ID: 0 0000 0000 0000 0011 0000 0000 0000 : 0x00003000
;;       FILTER1         0x00003000


  RECEIVE_BUFFERS    0x03F3FFFF, EXTENDED,0x1FFFFFFF, EXTENDED,0x00003000,EXTENDED
...
;;         Source = 0x0C, Cmd = 0x00
;; 29 bit ID: 0 0000 0000 0110 0000 0000 0110 0000 : 0x00060060
;       TXB2            0x00060060

; TX1 - Used for Ack and Error messages
;;   Priority = 0, Class = 0x04, Broadcast = 1, SubClass = 0x00
;;         Source = 0x0C, Cmd = 0x00
;; 29 bit ID: 0 0000 0001 0010 0000 0000 0110 0000 : 0x00120060
;       TXB1            0x00120060
...
;SCHEDULED_TRANSMISSION  MODE, INFO, MULTIPLIER, FREQUENCY
  ...
  ;; announce that it is alive - no data to send
...
;IO_DIRECTION    MACRO   B6, B5, B4, B3, B2, B1, B0
 ...
 IO_DIRECTION  OUTPUT,OUTPUT,OUTPUT,OUTPUT,INPUT,INPUT,INPUT
...
;IO_XMIT_ON_CHANGE   B7, B6, B5, B4, B3, B2, B1, B0
 ...
 IO_XMIT_ON_CHANGE DISABLED,DISABLED,DISABLED,DISABLED,IO_RISE,IO_RISE,IO_RISE,IO_RISE

...
;;
;; For input messages:
;;   Priority = 0, Class = 0x00, Broadcast = 0, Dest = 0x0B, 
;;         Source = 0x00, Cmd = 0x00
;; 29 bit ID: 0 0000 0000 0000 0010 1100 0000 0000 : 0x00002C00
;;       FILTER1         0x00002C00


  RECEIVE_BUFFERS    0x03F3FFFF, EXTENDED,0x1FFFFFFF, EXTENDED,0x00002C00,EXTENDED
...
;;         Source = 0x0B, Cmd = 0x00
;; 29 bit ID: 0 0000 0000 0110 0000 0000 0101 1000 : 0x00060058
;       TXB2            0x00060058

; TX1 - Used for Ack and Error messages
;;   Priority = 0, Class = 0x04, Broadcast = 1, SubClass = 0x00
;;         Source = 0x0B, Cmd = 0x00
;; 29 bit ID: 0 0000 0001 0010 0000 0000 0101 1000 : 0x00120058
;       TXB1            0x00120058
...
;       TXB2            0x00060058
  ...
  TRANSMIT_BUFFERS  0x00060058,EXTENDED,0x00120058,EXTENDED,0x00060058,EXTENDED
...
;SCHEDULED_TRANSMISSION  MODE, INFO, MULTIPLIER, FREQUENCY
 ...
 SCHEDULED_TRANSMISSION  ENABLED,NONE,5,X4096_4096TOSC
...
;IO_DIRECTION    MACRO   B6, B5, B4, B3, B2, B1, B0
 ...
 IO_DIRECTION  INPUT,INPUT,INPUT,OUTPUT,OUTPUT,OUTPUT,OUTPUT
...
;IO_XMIT_ON_CHANGE   B7, B6, B5, B4, B3, B2, B1, B0
 ...
 IO_XMIT_ON_CHANGE IO_RISE,IO_RISE,IO_RISE,IO_RISE,DISABLED,DISABLED,DISABLED,DISABLED
...
; auto-conversion rate: (Fosc/4/256)/512 = 33 mS
 ADC_SETUP DISABLED,TOSC512,ADC_FOSC_32,VDD,VSS,X1_64TOSC
